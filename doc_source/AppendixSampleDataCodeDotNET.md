...
The following C\# code example creates tables and uploads data to the tables\. The resulting table structure and data is shown in [Creating Tables and Loading Sample Data](SampleData.md)\. For step\-by\-step instructions to run this code in Visual Studio, see [\.NET Code Samples](CodeSamples.DotNet.md)\.
