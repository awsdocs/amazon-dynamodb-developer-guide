# Get, write, and delete batches of DynamoDB items using an AWS SDK<a name="example_dynamodb_Usage_BatchGetWriteDelete_section"></a>

The following code example shows how to get, write, and delete batches of DynamoDB items\.
...
Create functions to wrap DynamoDB batch operations\.  
...
def get_batch_data(movie_table, movie_list, actor_table, actor_list):
    ...
    try:
        ...
        return retrieved
```
Create a function to archive data from one table to another\.  
...
```
Call your functions to create tables, fill them with movie data from a JSON file, and archive items in another table\.  
