...
+ [Code examples for DynamoDB using AWS SDKs](service_code_examples.md)
   ...
   + [Scenarios for DynamoDB using AWS SDKs](service_code_examples_scenarios.md)
      ...
      + [Get, write, and delete batches of DynamoDB items using an AWS SDK](example_dynamodb_Usage_BatchGetWriteDelete_section.md)
      + [Query a DynamoDB table by batch using PartiQL and an AWS SDK](example_dynamodb_BatchExecuteStatement_section.md)
      + [Query a DynamoDB table using PartiQL and an AWS SDK](example_dynamodb_ExecuteStatement_section.md)
...
+ [Security and Compliance in Amazon DynamoDB](security.md)
   ...
   + [Identity and Access Management](identity-and-access-mgmt.md)
      + [Identity and Access Management in Amazon DynamoDB](authentication-and-access-control.md)
         ...
         + [Using Identity-Based Policies (IAM Policies) with Amazon DynamoDB](using-identity-based-policies.md)
