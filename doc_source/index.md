...
+ [Working with Tables, Items, Queries, Scans, and Indexes](WorkingWithDynamo.md)
   ...
   + [Change Data Capture with Amazon DynamoDB](streamsmain.md)
      + [Change Data Capture for Kinesis Data Streams with DynamoDB](kds.md)
         + [Getting Started with Amazon Kinesis Data Streams for Amazon DynamoDB](kds_gettingstarted.md)
         + [Custom IAM Policies for Amazon Kinesis Data Streams for Amazon DynamoDB](kds_iam.md)
