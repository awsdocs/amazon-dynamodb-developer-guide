...
1. Amazon SNS will send a confirmation message to your email address\. Click the **Confirm subscription** link in that message to complete the subscription process\.
