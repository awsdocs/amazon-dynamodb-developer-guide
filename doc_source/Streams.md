...
For complete descriptions of these API actions, including example requests and responses, go to the [Amazon DynamoDB Streams API Reference](http://docs.aws.amazon.com/dynamodbstreams/latest/APIReference/)\.
