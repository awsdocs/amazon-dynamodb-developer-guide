...
For more information, see [Capturing Table Activity with DynamoDB Streams](Streams.md)\. For the low\-level DynamoDB Streams API, see the [Amazon DynamoDB Streams API Reference](http://docs.aws.amazon.com/dynamodbstreams/latest/APIReference/)
