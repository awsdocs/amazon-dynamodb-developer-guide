...
**Note**  
 For more information about the DynamoDB naming rules and the various supported data types, see [Naming Rules and Data Types](HowItWorks.NamingRulesDataTypes.md)\. 
